...
- [x] **Negation** — resolved: prefix `no-`, phonologically bound to its host. See decisions.md and history.md 2026-05-15. Related sub-questions parked:
    ...
    - [~] Canonical stacking order for multiple prefixes — first rule locked 2026-06-07: `no-` is outermost, scoping over a `mi-`/`ze-` derived concept (`no-mi-X` = "not opposite-of-X"); `mi-`/`ze-` mutually exclusive on one root. Extend when interrogative/intensity prefixes are added. See decisions.md / history.md 2026-06-07.
