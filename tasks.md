...
- [ ] **Rental offer vs truck modifier attachment** — work trial A11 in [trials.md](trials.md): distinguish excluded driver services, autonomous capability, and nobody currently driving. Test existing grouping and explicit relative-clause predicates before adding grammar or roots. Candidate approaches and tradeoffs: history.md, 2026-09-24.
